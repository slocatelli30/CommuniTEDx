...
import json
import pyspark
from pyspark.sql.functions import col, collect_list, array_join, array_contains, array_intersect, array
...
tedx_dataset_agg = tedx_dataset_agg.filter(~array_contains(tedx_dataset_agg.tags,"design"))
